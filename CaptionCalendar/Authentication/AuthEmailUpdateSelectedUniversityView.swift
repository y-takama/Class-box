//
//  AuthEmailUpdateSelectedUniversityView.swift
//  CaptionCalendar
//
...
struct AuthEmailUpdateSelectedUniversityView: View {
...
//                Spacer()
                ...
                if selectionUniversityValue != "--" {
                    if selectionCampusValue != "--"  {
                        NavigationLink(
                            destination:
                                AuthEmailUpdateView(universityName: $selectionUniversityValue,
                                                              campusName:$selectionCampusValue,
                                                    emailUpdateView: $emailUpdateView).navigationBarHidden(true),
                            label: {
                                VStack {
                                    Text("Next!")
