...
struct Textbook: Identifiable, Decodable, Hashable {
    ...
    var answer1: Int?
    var answer2: Int?
    var useranswer1: Bool?
    var useranswer2: Bool?
    var timer: Int?
    ...
    init(dictionary: [String: Any]) {
        ...
        self.question_count = dictionary["question_count"] as? Int ?? 0
        ...
        self.useranswer1 = dictionary["useranswer1"] as? Bool ?? false
        self.useranswer2 = dictionary["useranswer2"] as? Bool ?? false
        self.timer = dictionary["timer"] as? Int ?? 0
        self.textbookID = dictionary["textbookID"] as? String ?? ""
