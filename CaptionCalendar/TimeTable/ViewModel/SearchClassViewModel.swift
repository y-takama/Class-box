...
//        self.classInfo = classInfo
    ...
    func fetchTimeTable() {
        ...
        //        let docRef = COLLECTION_TIMETABLE.document(user.university!).collection("2021AS")
    ...
    func registrationClass(dayOfWeek: String,
        ...
        let DogRef = COLLECTION_TIMETABLE.document(user.university!).collection("2021AS").document(classId).collection("registeredUser").document(uid)
...
//        let classChatRecentRef =  COLLECTION_TIMETABLE.document(user.university!).collection("2021AS").document(docID).collection("recent-messages")
