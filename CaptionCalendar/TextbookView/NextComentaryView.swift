...
struct NextComentaryView: View {
    ...
    init(showStudyView: Binding<Bool>,
        ...
        self.user = user
        self.viewModel = StudyNextContentView(detail: content)
...
//                AdView(adUnitID: "ca-app-pub-3940256099942544/2934735716")
        ...
        NavigationLink(destination: NextQuestionView(showStudyView: $showStudyView, showQuestion: $showQuestion, viewModel: StudyNextContentView(detail: viewModel.detail), content: viewModel.detail, user: user).navigationBarBackButtonHidden(true), isActive: $isShowingNext) {
        }
    }
